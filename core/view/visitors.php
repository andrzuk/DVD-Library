...
class Visitors_View
{
	...
	public function ShowForm($row, $failed)
	{
		...
		$main_cell  = '<script type="text/javascript">';
		$main_cell .= 'jQuery(document).ready(function() { jQuery("#multi input").dynDateTime({ button: ".next()" }); });';
		$main_cell .= '</script>';
		$main_cell .= '<div id="multi">';
		$main_cell .= '<input type="text" name="period_from" id="period_from" value="'.$period_from.'" class="FormInput" style="width: 150px;" readonly="readonly" /> <button type="button" class="styleButton">...</button>&nbsp; – &nbsp;';
		$main_cell .= '<input type="text" name="period_to" id="period_to" value="'.$period_to.'" class="FormInput" style="width: 150px;" readonly="readonly" /> <button type="button" class="styleButton">...</button>';
		$main_cell .= '</div>';
